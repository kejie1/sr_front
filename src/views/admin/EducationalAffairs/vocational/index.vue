  ...
  <div class="userContainer">
    <div class="search_btn">
      <div class="search_btn_container">
        <div class="search">
          <el-input placeholder="请输入专业名称" @input="searchVocationalList" v-model="searchParams">
            <i slot="prefix" class="el-input__icon el-icon-search"></i>
          </el-input>
        </div>
        <div class="addBtn">
          <el-button type="primary" plain @click="handleAddEdit">添加专业</el-button>
        </div>
      </div>
    </div>
    <el-table :key="Math.random()" :data="tableData" stripe style="width: 100%">
      ...
      <el-table-column label="操作" fixed="right" width="300">
        <template slot-scope="scope">
          <el-button type="primary" plain size="mini" @click="handleMoreInfo(scope.row)">查看班级列表</el-button>
    ...
    >
      <el-form
        ...
        label-width="100px"
      >
        <el-form-item label="专业名称" prop="vocationalStr">
          <el-input v-model="vocationalInfo.vocationalStr"></el-input>
        </el-form-item>
        <el-form-item label="专业负责人" prop="principal">
          <el-input v-model="vocationalInfo.principal"></el-input>
        </el-form-item>
        <el-form-item label="所属学院" prop="collegeId">
          <el-select v-model="vocationalInfo.collegeId" placeholder="请选择">
            <el-option
    ...
    <!-- 专业详细信息 -->
    <el-dialog title="专业详细信息" :visible.sync="vocationalMoreInfoVisible" width="30%">
