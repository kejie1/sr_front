<template>
  <div>
    ...
    >
      ...
      <el-menu-item index="3">学生宿舍管理</el-menu-item>
      <el-menu-item index="4">财务管理</el-menu-item>
      <el-submenu index="5">
        <template slot="title">教务管理</template>
        <el-menu-item index="5-1">学院管理</el-menu-item>
        <el-menu-item index="5-2">专业管理</el-menu-item>
        <el-menu-item index="5-3">班级管理</el-menu-item>
        <el-menu-item index="5-4">教师管理</el-menu-item>
      </el-submenu>
    </el-menu>
  </div>
</template>
