  ...
  <div class="userContainer">
    <div class="search_btn">
      <div class="search_btn_container">
        <div class="search">
          <el-input placeholder="请输入宿舍号" @input="searchHostel" v-model="searchParams">
            <i slot="prefix" class="el-input__icon el-icon-search"></i>
          </el-input>
        </div>
        <div class="addBtn">
          <el-button type="primary" plain @click="handleAddEdit">添加宿舍</el-button>
        </div>
      </div>
    </div>
    <el-table :key="Math.random()" :data="tableData" stripe style="width: 100%">
      ...
      <el-table-column prop="hostelSex" label="分类">
        <template slot-scope="scope">{{ scope.row.hostelSex == 1 ? "男" : "女" }}</template>
      </el-table-column>
      ...
      <el-table-column label="操作" fixed="right" width="300">
        <template slot-scope="scope">
          <el-button type="primary" plain size="mini" @click="handleMoreInfo(scope.row)">查看宿舍人数</el-button>
    ...
    <el-dialog
      ...
      @close="handleCancel"
    >
      <el-form :model="hostelInfo" :rules="hostelfoRules" ref="hostelInfo" label-width="100px">
    ...
    <!-- 宿舍详细信息 -->
    <el-dialog title="宿舍详细信息" :visible.sync="hostelMoreInfoVisible" width="50%">
      <el-table :key="Math.random()" :data="moreInfoList" stripe style="width: 100%">
